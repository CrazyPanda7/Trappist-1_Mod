...
public class Trappist1bPlains extends WE_Biome{
	public Trappist1bPlains() 
	{
		super(new BiomeProperties("Trappist1bPlains"), new int[] {0x00FF00, 0xEEDD44, 0x00FF00});
		...
		standardBiomeLayers.add(ModBlocks.B_ROCK, (byte)4, ModBlocks.B_ROCK, (byte)1, -256, 0, -256,  0, false);
