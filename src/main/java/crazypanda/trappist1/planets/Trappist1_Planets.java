...
public class Trappist1_Planets {
	...
	public static void init()
	{
		...
		Trappist1.setBodyIcon(new ResourceLocation(Reference.MOD_ID, "textures/CelestialBodies/trappist1.png"));
		...
		Trappist1b.setBodyIcon(new ResourceLocation(Reference.MOD_ID, "textures/CelestialBodies/trappist1bicon.png"));
